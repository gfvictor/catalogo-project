<x-layout>
    <div class="h-screen bg-white flex justify-center items-center">
        <div class="lg:w-2/5 md:w-1/2 w-2/3">
            <form action="{{route('objects.update', ['id' => $object->id])}}" method="POST" class="bg-white rounded-md shadow-2xl p-5 min-w-full">
                @csrf
                @method('PUT')
                ...
                <div>
                    <input value="{{$object->container_name}}" class="w-full bg-gray-100 placeholder-gray-400 text-gray-500 px-4 py-3 mt-6 rounded-2xl focus:outline-none" type="number" min="1" name="container_name" id="container_name"
