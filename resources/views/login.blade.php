        ...
        <div class="container">
            <div class="bg-white rounded-lg shadow-lg p-5 md:p-20 mx-2">
                <div class="text-center">
                    ...
                    <p class="text-md md:text-xl mt-10"><a class="hover:underline" href="#">Nome do App</a> um web app que torna mais fácil a organização da casa.</p>
                </div>
                <div>
                    <div class="flex justify-center text-center">
                        <a href="{{route('overview', ['id' => auth()->user()->id])}}" title="Quicktoolz On Facebook"
