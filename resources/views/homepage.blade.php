                ...
                @else
                    <form action="/login" method="POST" class="bg-white rounded-md shadow-2xl p-5">
                        ...
                        <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
                            ...
                            <input class=" pl-2 w-full outline-none border-none" type="email" name="loginemail" id="email" placeholder="Email" />
                        </div>
                        ...
                        <button type="submit" class="block w-full bg-purple-600 mt-5 py-2 rounded-2xl hover:bg-purple-700 hover:-translate-y-1 transition-all duration-500 text-white font-semibold
                    mb-2">Login</button>
